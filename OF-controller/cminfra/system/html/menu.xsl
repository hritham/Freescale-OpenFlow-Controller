  ...
  <xsl:template match="root">
    <div>
      <xsl:variable name="icon">
        <xsl:value-of select="'images/bullet.gif'" />
      </xsl:variable>      
      <img src='images/bullet.gif' border="0" align="absMiddle" width="23" height="23"/>
      <a href="welcome.htm" target="rightPanel">
         <xsl:text>Home</xsl:text>
      </a>
      <xsl:apply-templates />
      <img src='images/bullet.gif' border="0" align="absMiddle" width="23" height="23"/>
      <a href="logout.htm" target="rightPanel">
