...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template name="gen_mList">
    ...
    <select multiple="true" size="7" onChange="selectedValue(this);">
      ...
      <xsl:when test="($mData/obj[@oid=$objID]/@type='INT') and not($mData/obj[@oid=$objID]/list)">
         ...
         <xsl:call-template name="createIntOptionMlist">
   ...
   <xsl:template name="createIntOptionMlist">
