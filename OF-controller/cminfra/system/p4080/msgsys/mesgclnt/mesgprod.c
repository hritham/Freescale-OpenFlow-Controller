...
#endif
#ifdef CM_SYSLOG_SCHEDULE
int32_t UCMGetDefaultSysLogSchedule(LogSchedule_t *pLogSchedule)
{
  if(pLogSchedule == NULL)
  {
    return OF_FAILURE;
  }
  pLogSchedule->ucHr = ConfigSchedule.ucHr;
  pLogSchedule->ucType = ConfigSchedule.ucType;
  pLogSchedule->ucWeek = ConfigSchedule.ucWeek;
