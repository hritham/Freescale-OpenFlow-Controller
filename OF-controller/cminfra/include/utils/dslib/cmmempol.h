...
#define OF_DSLIB_MEMPOOL_GET_FIRST_POOL_STATS  (DSLIB_MEMPOOL_IOCTL_BASE + 0)
#define OF_DSLIB_MEMPOOL_GET_NEXT_POOL_STATS   (DSLIB_MEMPOOL_IOCTL_BASE + 1)
#define OF_DSLIB_MEMPOOL_GET_EXACT_POOL_STATS  (DSLIB_MEMPOOL_IOCTL_BASE + 2)
#define OF_DSLIB_MEMPOOL_ENABLE_FORCED_FAILURE (DSLIB_MEMPOOL_IOCTL_BASE + 3)
#define OF_DSLIB_MEMPOOL_DISABLE_FORCED_FAILURE (DSLIB_MEMPOOL_IOCTL_BASE + 4)
