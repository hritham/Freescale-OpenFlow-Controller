 ...
 * @pay_load_p:  the data_p in the hash
 * @name_p:  the name_p associated
 *
 * Callback to free data_p from a hash.
 */
 ...
 * @name_p:  the name_p associated
 *
 * Callback to copy data_p from a hash.
 *
 * Returns a copy of the data_p or NULL in case of error.
 */
typedef void *(*cm_hash_copier) (void * pay_load_p, char * name_p);
/**
 * cm_hash_scanner:
 * @pay_load_p:  the data_p in the hash
 * @data_p:  extra scannner data_p
 * @name_p:  the name_p associated
 *
 * Callback when scanning data_p in a hash with the simple scanner.
 */
typedef void (*cm_hash_scanner) (void * pay_load_p, void * data_p,
                                  char * name_p);
/**
 ...
 *
 * Callback when scanning data_p in a hash with the full scanner.
 */
typedef void (*cm_hash_scanner_full) (void * pay_load_p, void * data_p,
                                      const char * name_p,
                                      const char * name_p2,
                                      const char * name_p3);
...
void cm_hash_scan (struct cm_hash_table * table, cm_hash_scanner f, void * data_p);
void
cm_hash_scan3 (struct cm_hash_table * table,
              const char * name_p,
              const char * name_p2,
              const char * name_p3, cm_hash_scanner f, void * data_p);
...
void cm_hash_scan_full3 (struct cm_hash_table * table, const char * name_p,
                         const char * name_p2, const char * name_p3,
                         cm_hash_scanner_full f, void * data_p);
