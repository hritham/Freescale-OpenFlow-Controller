...
struct _xmlSchemaAnnot {
    ...
    IXML_Node *content;         /* the annotation */
};
...
XMLPUBFUN xmlChar* ixmlEncodeEntitiesReentrant(IXML_Document *doc, const xmlChar *input);
XMLPUBFUN int ixmlCheckLanguageID(const xmlChar * lang);
XMLPUBFUN int ixmlValidateNMToken(const xmlChar *value, int space);
XMLPUBFUN int ixmlValidateName(const xmlChar *value, int space);
