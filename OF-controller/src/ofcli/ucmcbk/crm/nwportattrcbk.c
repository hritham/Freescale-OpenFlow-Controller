...
/*
 *
 * File name: nwportattributecbk.c
 * 
 */
...
int32_t crm_nwport_attribute_addrec (void * config_trans_p,
			struct cm_array_of_iv_pairs * pMandParams,
			struct cm_array_of_iv_pairs * pOptParams,
			struct cm_app_result ** result_p);
int32_t crm_nwport_attribute_setrec (void * config_trans_p,
		  		     struct cm_array_of_iv_pairs * pMandParams,
			             struct cm_array_of_iv_pairs * pOptParams,
			             struct cm_app_result ** result_p);


int32_t crm_nwport_attribute_delrec (void * config_transaction_p,
...
int32_t crm_nwport_attribute_getfirstnrecs(struct cm_array_of_iv_pairs * keys_arr_p,
                        uint32_t * count_p,
                        struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);

int32_t crm_nwport_attribute_getnextnrecs (struct cm_array_of_iv_pairs * keys_arr_p,
                        struct cm_array_of_iv_pairs *prev_record_key_p, uint32_t * count_p,
                        struct cm_array_of_iv_pairs ** next_n_record_data_p);

int32_t crm_nwport_attribute_getexactrec (struct cm_array_of_iv_pairs * keys_arr_p,
...
int32_t crm_nwport_attribute_ucm_validatemandparams (struct cm_array_of_iv_pairs *pMandParams,
			struct cm_app_result **presult_p);



int32_t crm_nwport_attribute_ucm_setmandparams (struct cm_array_of_iv_pairs *pMandParams,
			char *nwport_name_p,
...
struct cm_dm_app_callbacks crm_nwport_attribute_ucm_callbacks = 
{
  NULL,
  crm_nwport_attribute_addrec,
  crm_nwport_attribute_setrec,
  crm_nwport_attribute_delrec,
  NULL,
  crm_nwport_attribute_getfirstnrecs,
  crm_nwport_attribute_getnextnrecs,
  crm_nwport_attribute_getexactrec,
  crm_nwport_attribute_verifycfg,
  NULL
};
			             ...
			             struct cm_app_result ** result_p)
{
  ...
  char nwport_name[CRM_MAX_VM_NAME_LEN+1];
  uint64_t nwport_handle;
  ...
  of_memset(nwport_name, 0, sizeof(nwport_name));
  if ((crm_nwport_attribute_ucm_setmandparams (pMandParams, 
	      nwport_name, &crm_attribute_name_value_info, 
  ...
  return_value = crm_add_attribute_to_port(nwport_name, &crm_attribute_name_value_info);
                        ...
                        struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
  ...
  of_memset (&crm_attribute_name_value_info, 0, sizeof (struct crm_attribute_name_value_pair));
  of_memset(nwport_name, 0, sizeof(nwport_name));
  if ((crm_nwport_attribute_ucm_setmandparams (prev_record_key_p, 
		nwport_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
  ...
  if ((crm_nwport_attribute_ucm_setmandparams (keys_arr_p, 
		nwport_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
  ...
  return_value = crm_get_port_next_attribute(nwport_name, crm_attribute_name_value_info.name_string,&crm_attribute_output);
  if (return_value != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("crm_get_nwport_next_attribute_name failed!");
    return OF_FAILURE;
  }
 ...
 if (result_iv_pairs_p == NULL)
 {
  ...
  crm_attribute_nwport_getparams(&crm_attribute_output, &result_iv_pairs_p[uiRecCount]);
  uiRecCount++;
		...
		struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
  ...
  of_memset (&crm_attribute_name_value_info, 0, sizeof (struct crm_attribute_name_value_pair));
  of_memset(nwport_name, 0, sizeof(nwport_name));
  if ((crm_nwport_attribute_ucm_setmandparams (keys_arr_p, nwport_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
     return OF_FAILURE;
  ...
  return_value = crm_get_port_first_attribute(nwport_name, &crm_attribute_output);
  if (return_value != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("crm_get_first_nwport_attribute_name failed!");
     return OF_FAILURE;
   }
   result_iv_pairs_p = (struct cm_array_of_iv_pairs *) of_calloc (1, sizeof (struct cm_array_of_iv_pairs));
  if (result_iv_pairs_p == NULL)
...

{
  ...
  return_value = crm_get_port_exact_attribute(nwport_name, crm_attribute_name_value_info.name_string);
    if (return_value != OF_SUCCESS)
     {
  ...
  crm_attribute_nwport_getparams (&crm_attribute_name_value_info, result_iv_pairs_p);
  *pIvPairArr = result_iv_pairs_p;
  return return_value;
}

int32_t crm_attribute_nwport_getparams (struct crm_attribute_name_value_output_info *attribute_info,
		struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
  ...
  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_NWPORTATTR_ATTRIBNAME_ID,
			CM_DATA_TYPE_STRING, attribute_info->name_string);
  uindex_i++;

  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_NWPORTATTR_ATTRIBVAL_ID,
				 ...
				 uiMandParamCnt++)
   {
     switch (pMandParams->iv_pairs[uiMandParamCnt].id_ui)
     {
       case CM_DM_NWSIDEPORTS_PORTNAME_ID:
             of_strncpy (nwport_name_p,(char *) pMandParams->iv_pairs[uiMandParamCnt].value_p,pMandParams->iv_pairs[uiMandParamCnt].value_length);
	     CM_CBK_DEBUG_PRINT ("nwport_name %s",nwport_name_p);
             break;


      case CM_DM_NWPORTATTR_ATTRIBNAME_ID:
     ...
     case CM_DM_NWPORTATTR_ATTRIBVAL_ID:
			...
			struct cm_app_result ** result_p)
{
  ...
  if ((crm_nwport_attribute_ucm_setmandparams (keys_arr_p, nwport_name, &attribute_info, &attribute_result)) != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
     fill_app_result_struct (&attribute_result, NULL, CM_GLU_SET_MAND_PARAM_FAILED);
     *result_p = attribute_result;
  ...
  return_value=crm_delete_attribute_from_port(nwport_name, &attribute_info);
  if (return_value != OF_SUCCESS)
  {
  ...
  CM_CBK_DEBUG_PRINT ("nwport attribute deleted succesfully");
  return OF_SUCCESS;
}
#endif
