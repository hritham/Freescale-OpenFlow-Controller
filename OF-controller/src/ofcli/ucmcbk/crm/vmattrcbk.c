...
int32_t crm_vm_attribute_appl_ucmcbk_init (void);

int32_t crm_vm_attribute_addrec (void * config_trans_p,
			struct cm_array_of_iv_pairs * pMandParams,
			struct cm_array_of_iv_pairs * pOptParams,
			struct cm_app_result ** result_p);
int32_t crm_vm_attribute_setrec (void * config_trans_p,
		  		     struct cm_array_of_iv_pairs * pMandParams,
			             struct cm_array_of_iv_pairs * pOptParams,
			             struct cm_app_result ** result_p);


int32_t crm_vm_attribute_delrec (void * config_transaction_p,
			struct cm_array_of_iv_pairs * keys_arr_p,
			struct cm_app_result ** result_p);

int32_t crm_vm_attribute_verifycfg (struct cm_array_of_iv_pairs * keys_arr_p,
			uint32_t command_id, struct cm_app_result ** result_p);

int32_t crm_vm_attribute_getfirstnrecs(struct cm_array_of_iv_pairs * keys_arr_p,
                        uint32_t * count_p,
                        struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);

int32_t crm_vm_attribute_getnextnrecs (struct cm_array_of_iv_pairs * keys_arr_p,
                        struct cm_array_of_iv_pairs *prev_record_key_p, uint32_t * count_p,
                        struct cm_array_of_iv_pairs ** next_n_record_data_p);

int32_t crm_vm_attribute_getexactrec (struct cm_array_of_iv_pairs * keys_arr_p,
...
int32_t crm_vm_attribute_ucm_validatemandparams (struct cm_array_of_iv_pairs *pMandParams,
			struct cm_app_result **presult_p);



int32_t crm_vm_attribute_ucm_setmandparams (struct cm_array_of_iv_pairs *pMandParams,
			char *vm_name_p,
...
struct cm_dm_app_callbacks crm_vm_attribute_ucm_callbacks = 
{
  NULL,
  crm_vm_attribute_addrec,
  crm_vm_attribute_setrec,
  crm_vm_attribute_delrec,
  NULL,
  crm_vm_attribute_getfirstnrecs,
  crm_vm_attribute_getnextnrecs,
  crm_vm_attribute_getexactrec,
  crm_vm_attribute_verifycfg,
  NULL
};
...
int32_t crm_vm_attribute_appl_ucmcbk_init (void)
{
  ...
  cm_register_app_callbacks (CM_ON_DIRECTOR_CRM_VIRTUALMACHINE_VMATTRIBUTE_APPL_ID, &crm_vm_attribute_ucm_callbacks);
  return OF_SUCCESS;
}
			             ...
			             struct cm_app_result ** result_p)
{
  ...
  of_memset(vm_name, 0, sizeof(vm_name));
  if ((crm_vm_attribute_ucm_setmandparams (pMandParams, 
	      vm_name, &crm_attribute_name_value_info, 
  ...
  return_value = crm_get_vm_handle(vm_name, &vm_handle);
  if (return_value != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("vm does not exist with name %s",vm_name);
    fill_app_result_struct (&attribute_result, NULL, CM_GLU_VM_NAME_NULL);
    *result_p = attribute_result;
    return OF_FAILURE;
  }
  return_value = crm_add_attribute_to_vm(vm_handle, &crm_attribute_name_value_info);
  if (return_value != OF_SUCCESS)
  {
                        ...
                        struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
  ...
  of_memset (&crm_attribute_name_value_info, 0, sizeof (struct crm_attribute_name_value_pair));
  of_memset(vm_name, 0, sizeof(vm_name));
  if ((crm_vm_attribute_ucm_setmandparams (prev_record_key_p, 
		vm_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
  ...
  if ((crm_vm_attribute_ucm_setmandparams (keys_arr_p, 
		vm_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
  ...
  return_value = crm_get_vm_next_attribute(vm_handle, crm_attribute_name_value_info.name_string,&crm_attribute_output);
  if (return_value != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("crm_get_vm_next_attribute_name failed!");
    return OF_FAILURE;
  }
 ...
 if (result_iv_pairs_p == NULL)
 {
  ...
  crm_attribute_vm_getparams(&crm_attribute_output, &result_iv_pairs_p[uiRecCount]);
  uiRecCount++;
		...
		struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
  ...
  of_memset (&crm_attribute_name_value_info, 0, sizeof (struct crm_attribute_name_value_pair));
  of_memset(vm_name, 0, sizeof(vm_name));
  if ((crm_vm_attribute_ucm_setmandparams (keys_arr_p, vm_name, &crm_attribute_name_value_info, 
					NULL)) != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
     return OF_FAILURE;
  ...
  if (return_value != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Subnet does not exist with id %s",vm_name);
    return OF_FAILURE;
  }
  ...
  return_value = crm_get_vm_first_attribute(vm_handle, &crm_attribute_output);
  if (return_value != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("crm_get_first_vm_attribute_name failed!");
     return OF_FAILURE;
   }
result_iv_pairs_p = (struct cm_array_of_iv_pairs *) of_calloc (1, sizeof (struct cm_array_of_iv_pairs));
  if (result_iv_pairs_p == NULL)
...

{
  ...
  return_value = crm_get_vm_exact_attribute(vm_handle, crm_attribute_name_value_info.name_string);
    if (return_value != OF_SUCCESS)
     {
  ...
  crm_attribute_vm_getparams (&crm_attribute_name_value_info, result_iv_pairs_p);
  *pIvPairArr = result_iv_pairs_p;
  return return_value;
}

int32_t crm_attribute_vm_getparams (struct crm_attribute_name_value_output_info *attribute_info,
		struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
  ...
  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_VMATTRIBUTE_ATTRIBUTENAME_ID,
			CM_DATA_TYPE_STRING, attribute_info->name_string);
  uindex_i++;

  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_VMATTRIBUTE_ATTRIBUTEVAL_ID,
				 ...
				 uiMandParamCnt++)
   {
     switch (pMandParams->iv_pairs[uiMandParamCnt].id_ui)
     {
       case CM_DM_VIRTUALMACHINE_NAME_ID:
             of_strncpy (vm_name_p,(char *) pMandParams->iv_pairs[uiMandParamCnt].value_p,pMandParams->iv_pairs[uiMandParamCnt].value_length);
	     CM_CBK_DEBUG_PRINT ("vm_name %s",vm_name_p);
             break;


      case CM_DM_VMATTRIBUTE_ATTRIBUTENAME_ID:
     ...
     case CM_DM_VMATTRIBUTE_ATTRIBUTEVAL_ID:
			...
			uint32_t command_id, struct cm_app_result ** result_p)
{
  ...
  return_value = crm_vm_attribute_ucm_validatemandparams (keys_arr_p, &attribute_result);
  if (return_value != OF_SUCCESS)
  {
...
int32_t crm_vm_attribute_ucm_validatemandparams (struct cm_array_of_iv_pairs *
			...
			struct cm_app_result ** result_p)
{
  ...
  if ((crm_vm_attribute_ucm_setmandparams (keys_arr_p, vm_name, &attribute_info, &attribute_result)) != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
     fill_app_result_struct (&attribute_result, NULL, CM_GLU_SET_MAND_PARAM_FAILED);
     *result_p = attribute_result;
  ...
  if (return_value != OF_SUCCESS)
   {
     CM_CBK_DEBUG_PRINT ("Get vm handle failed");
     fill_app_result_struct (&attribute_result, NULL, CM_GLU_VM_NAME_NULL);
     *result_p = attribute_result;
     return OF_FAILURE;
   }
  return_value=crm_delete_attribute_from_vm(vm_handle, &attribute_info);
  if (return_value != OF_SUCCESS)
  {
  ...
  CM_CBK_DEBUG_PRINT ("vm attribute deleted succesfully");
  return OF_SUCCESS;
}
#endif
