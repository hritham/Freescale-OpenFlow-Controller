...
int32_t nsrm_nwservice_attribute_addrec (void * config_trans_p,
                                     struct cm_array_of_iv_pairs * pMandParams,
                                     struct cm_array_of_iv_pairs * pOptParams,
                                     struct cm_app_result ** result_p);
int32_t nsrm_nwservice_attribute_setrec (void * config_trans_p,
                                     struct cm_array_of_iv_pairs * pMandParams,
                                     struct cm_array_of_iv_pairs * pOptParams,
                                     struct cm_app_result ** result_p);

int32_t nsrm_nwservice_attribute_delrec (void * config_transaction_p,
                                     struct cm_array_of_iv_pairs * keys_arr_p,
                                     struct cm_app_result ** result_p);


int32_t nsrm_nwservice_attribute_getfirstnrecs(struct cm_array_of_iv_pairs * keys_arr_p,
                                               uint32_t * count_p,
                                               struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);



int32_t nsrm_nwservice_attribute_getnextnrecs (struct cm_array_of_iv_pairs * keys_arr_p,
                                               struct cm_array_of_iv_pairs * prev_record_key_p,
                                               uint32_t * count_p,
                                               struct cm_array_of_iv_pairs ** next_n_record_data_p);


int32_t nsrm_nwservice_attribute_getexactrec (struct cm_array_of_iv_pairs * keys_arr_p,
                                             struct cm_array_of_iv_pairs ** pIvPairArr);

int32_t nsrm_nwservice_attribute_verifycfg (struct cm_array_of_iv_pairs *key_iv_pairs_p,
                        uint32_t command_id, struct cm_app_result ** result_p);

struct cm_dm_app_callbacks  nsrm_nwservice_attribute_ucm_callbacks =
{
  NULL,
  nsrm_nwservice_attribute_addrec,
  nsrm_nwservice_attribute_setrec,
  nsrm_nwservice_attribute_delrec,
  NULL,
  nsrm_nwservice_attribute_getfirstnrecs,
  nsrm_nwservice_attribute_getnextnrecs,
  nsrm_nwservice_attribute_getexactrec,
  nsrm_nwservice_attribute_verifycfg, 
 NULL
};

/***************************************************************************************************/
int32_t nsrm_nwservice_attribute_appl_ucmcbk_init (void)
{
  CM_CBK_DEBUG_PRINT ("Entry");
  if(cm_register_app_callbacks (CM_ON_DIRECTOR_NSRM_SERVICE_SERVICEATTRIBUTE_APPL_ID, &nsrm_nwservice_attribute_ucm_callbacks) != OF_SUCCESS)
    return OF_FAILURE;
                                     ...
                                     struct cm_app_result ** result_p)
{
  ...
  nwservice_object_name_p = (char*)of_calloc(1,NSRM_MAX_NAME_LEN);
  if((nsrm_nwservice_attribute_ucm_setmandparams (
                                               pMandParams,
                                               nwservice_object_name_p, &nsrm_attribute_name_value_info,
                                     ...
                                     struct cm_app_result ** result_p)
{
  ...
  ret_value = nsrm_del_attribute_from_nwservice_object(nwservice_object_name_p,
                                               ...
                                               struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
  ...
  nwservice_object_name_p = (char*)of_calloc(1,NSRM_MAX_NAME_LEN);
  if((nsrm_nwservice_attribute_ucm_setmandparams (keys_arr_p,nwservice_object_name_p,
                                                  &nsrm_attribute_name_value_info,NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
    return OF_FAILURE;
  }
  if((nsrm_nwservice_attribute_ucm_setmandparams (prev_record_key_p,nwservice_object_name_p,
                                                  &nsrm_attribute_name_value_info,NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
    of_free(nwservice_object_name_p);
  ...
  return_value = nsrm_get_next_nwservice_object_attribute(
                                                       nwservice_object_name_p,
                                                       nsrm_attribute_name_value_info.attribute_name_p, 
  ...
  nsrm_nwservice_attribute_getparams(&nsrm_attribute_output, &result_iv_pairs_p[uiRecCount]);
  uiRecCount++;
                                               ...
                                               struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
  ...
  return_value = nsrm_get_first_nwservice_object_attribute(
                                                        nwservice_object_name_p,
                                                        &nsrm_attribute_output);
  if (return_value != OF_SUCCESS)
  {
                                             ...
                                             struct cm_array_of_iv_pairs ** pIvPairArr)
{
  ...
  return_value = nsrm_get_exact_nwservice_object_attribute(
                                                        nwservice_object_name_p, 
                                                        nsrm_attribute_name_value_info.attribute_name_p,
                                                        &nsrm_attribute_output
                                                        );
   ...
   nsrm_nwservice_attribute_getparams(&nsrm_attribute_output, result_iv_pairs_p);
...
int32_t nsrm_nwservice_attribute_ucm_setmandparams (struct cm_array_of_iv_pairs *pMandParams,
                        char*  nwservice_object_name_p,
   ...
   {  
     ...
     switch (pMandParams->iv_pairs[uiMandParamCnt].id_ui)
     {
       case CM_DM_SERVICE_NAME_ID:
             of_strncpy (nwservice_object_name_p,(char *) pMandParams->iv_pairs[uiMandParamCnt].value_p,
                         pMandParams->iv_pairs[uiMandParamCnt].value_length);
             CM_CBK_DEBUG_PRINT ("nwservice_name %s",nwservice_object_name_p);
             break;

      case CM_DM_SERVICEATTRIBUTE_ATTRIBUTENAME_ID:
     ...
     case CM_DM_SERVICEATTRIBUTE_ATTRIBUTEVAL_ID:
...
int32_t nsrm_nwservice_attribute_getparams (struct nsrm_attribute_name_value_output_info *attribute_info,
                                            struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
  ...
  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_SERVICEATTRIBUTE_ATTRIBUTENAME_ID,
                   CM_DATA_TYPE_STRING, attribute_info->name_p);
  uindex_i++;

  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_SERVICEATTRIBUTE_ATTRIBUTEVAL_ID,
