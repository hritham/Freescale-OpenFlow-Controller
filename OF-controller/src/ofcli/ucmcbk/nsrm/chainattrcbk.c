...
int32_t nsrm_nschain_attribute_addrec (void * config_trans_p,
                                     struct cm_array_of_iv_pairs * pMandParams,
                                     struct cm_array_of_iv_pairs * pOptParams,
                                     struct cm_app_result ** result_p);
int32_t nsrm_nschain_attribute_setrec (void * config_trans_p,
                                     struct cm_array_of_iv_pairs * pMandParams,
                                     struct cm_array_of_iv_pairs * pOptParams,
                                     struct cm_app_result ** result_p);

int32_t nsrm_nschain_attribute_delrec (void * config_transaction_p,
                                     struct cm_array_of_iv_pairs * keys_arr_p,
                                     struct cm_app_result ** result_p);


int32_t nsrm_nschain_attribute_getfirstnrecs(struct cm_array_of_iv_pairs * keys_arr_p,
                                               uint32_t * count_p,
                                               struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p);



int32_t nsrm_nschain_attribute_getnextnrecs (struct cm_array_of_iv_pairs * keys_arr_p,
                                               struct cm_array_of_iv_pairs * prev_record_key_p,
                                               uint32_t * count_p,
                                               struct cm_array_of_iv_pairs ** next_n_record_data_p);


int32_t nsrm_nschain_attribute_getexactrec (struct cm_array_of_iv_pairs * keys_arr_p,
                                             struct cm_array_of_iv_pairs ** pIvPairArr);

int32_t nsrm_nschain_attribute_verifycfg (struct cm_array_of_iv_pairs *key_iv_pairs_p,
                        uint32_t command_id, struct cm_app_result ** result_p);

struct cm_dm_app_callbacks  nsrm_nschain_attribute_ucm_callbacks =
{
  NULL,
  nsrm_nschain_attribute_addrec,
  nsrm_nschain_attribute_setrec,
  nsrm_nschain_attribute_delrec,
  NULL,
  nsrm_nschain_attribute_getfirstnrecs,
  nsrm_nschain_attribute_getnextnrecs,
  nsrm_nschain_attribute_getexactrec,
  nsrm_nschain_attribute_verifycfg, 
 NULL
};

/***************************************************************************************************/
int32_t nsrm_nschain_attribute_appl_ucmcbk_init (void)
{
  CM_CBK_DEBUG_PRINT ("Entry");
  if(cm_register_app_callbacks (CM_ON_DIRECTOR_NSRM_CHAIN_CHAINATTRIBUTE_APPL_ID, &nsrm_nschain_attribute_ucm_callbacks) != OF_SUCCESS)
    return OF_FAILURE;
                                     ...
                                     struct cm_app_result ** result_p)
{
  ...
  if((nsrm_nschain_attribute_ucm_setmandparams (
                                               pMandParams,
                                               nschain_object_name_p, &nsrm_attribute_name_value_info,
  ...
  ret_value = nsrm_add_attribute_to_nschain_object(nschain_object_name_p,
                                     ...
                                     struct cm_app_result ** result_p)
{
  ...
  ret_value = nsrm_del_attribute_from_nschain_object(nschain_object_name_p,
                                               ...
                                               struct cm_array_of_iv_pairs ** next_n_record_data_p)
{
  ...
  nschain_object_name_p = (char*)of_calloc(1,NSRM_MAX_NAME_LEN);
  if((nsrm_nschain_attribute_ucm_setmandparams (keys_arr_p,nschain_object_name_p,
                                                  &nsrm_attribute_name_value_info,NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
    return OF_FAILURE;
  }
  if((nsrm_nschain_attribute_ucm_setmandparams (prev_record_key_p,nschain_object_name_p,
                                                  &nsrm_attribute_name_value_info,NULL)) != OF_SUCCESS)
  {
    CM_CBK_DEBUG_PRINT ("Set Mandatory Parameters Failed");
    of_free(nschain_object_name_p);
  ...
  return_value = nsrm_get_next_nschain_object_attribute(
  ...
  nsrm_nschain_attribute_getparams(&nsrm_attribute_output, &result_iv_pairs_p[uiRecCount]);
  uiRecCount++;
                                               ...
                                               struct cm_array_of_iv_pairs ** array_of_iv_pair_arr_p)
{
  ...
  return_value = nsrm_get_first_nschain_object_attribute(
                                                        nschain_object_name_p,
                                                        &nsrm_attribute_output);
  if (return_value != OF_SUCCESS)
  {
                                             ...
                                             struct cm_array_of_iv_pairs ** pIvPairArr)
{
  ...
  return_value = nsrm_get_exact_nschain_object_attribute(
                                                        nschain_object_name_p, 
                                                        nsrm_attribute_name_value_info.attribute_name_p,
                                                        &nsrm_attribute_output
                                                        );
   ...
   nsrm_nschain_attribute_getparams(&nsrm_attribute_output, result_iv_pairs_p);
...
int32_t nsrm_nschain_attribute_ucm_setmandparams (struct cm_array_of_iv_pairs *pMandParams,
                        char*  nschain_object_name_p,
   ...
   {  
     ...
     switch (pMandParams->iv_pairs[uiMandParamCnt].id_ui)
     {
       case CM_DM_CHAIN_NAME_ID:
             ...
             CM_CBK_DEBUG_PRINT ("nschain_name %s",nschain_object_name_p);
             break;

      case CM_DM_CHAINATTRIBUTE_ATTRIBUTENAME_ID:
     ...
     case CM_DM_CHAINATTRIBUTE_ATTRIBUTEVALUE_ID:
...
int32_t nsrm_nschain_attribute_getparams (struct nsrm_attribute_name_value_output_info *attribute_info,
                                            struct cm_array_of_iv_pairs * result_iv_pairs_p)
{
  ...
  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_CHAINATTRIBUTE_ATTRIBUTENAME_ID,
                   CM_DATA_TYPE_STRING, attribute_info->name_p);
  uindex_i++;

  FILL_CM_IV_PAIR (result_iv_pairs_p->iv_pairs[uindex_i],CM_DM_CHAINATTRIBUTE_ATTRIBUTEVALUE_ID,
