 ...
 * Date  : Jan , 2014  
 * Description: 
 *  This file contains tcp protocol specific definitions and structures.
 * History:
 */
...
int32_t cntlr_register_tcp_proto(void);
int32_t cntlr_unregister_tcp_proto(void);
...
int32_t tcp_transport_close (int32_t fd ,
		void *conn_spec_info);
