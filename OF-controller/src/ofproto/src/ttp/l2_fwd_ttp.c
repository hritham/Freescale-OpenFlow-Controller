...
/******************************************************************************
* Function:l2_fwd_ttp_table_init
* Description:
...
int32_t l2_fwd_ttp_init()
{
  ...
  strcpy(ttp_info_g[ttp_index].ttp_name, "SAMPLE_L2_FWD_TTP");
  ...
  for(table_id=0; table_id<CNTLR_SAMPLE_L2_FWD_TTP_TABLES_CNT; table_id++)
  {
    ...
    if(ret_val != MEMPOOL_SUCCESS)
    {
      ...
      goto SAMPLE_L2_FWD_TTP_INIT_EXIT;
    }
    ...
    switch(table_id)
    {
      ...
      case 0:
        ...
        strcpy(ttp_table_node_p->table_name, CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID0_NAME);    		
        ttp_table_node_p->max_columns    = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID0_COLUMNS;
        ttp_table_node_p->max_rows       = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID0_ROWS;
        ...
        if(ret_val != MEMPOOL_SUCCESS)
        {
	  OF_LOG_MSG(OF_LOG_TTP, OF_LOG_ERROR, "Add dest mac addr with mask match field to EthaddressTypeTable failed.");
	  ret_val = CNTLR_TTP_FAILURE;
	  goto SAMPLE_L2_FWD_TTP_INIT_EXIT;
        }
	break;	
      ...
      case 1:
        ...
        strcpy(ttp_table_node_p->table_name,CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID1_NAME);    		
        ttp_table_node_p->max_columns    = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID1_COLUMNS;
        ttp_table_node_p->max_rows = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID1_ROWS;
	...
	break;	
      ...
      case 2:	
        ...
        strcpy(ttp_table_node_p->table_name,CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID2_NAME);    		
        ttp_table_node_p->max_columns    = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID2_COLUMNS;//1
        ttp_table_node_p->max_rows = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID2_ROWS;//10
      ...
      case 3:	
        ...
        strcpy(ttp_table_node_p->table_name,CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID3_NAME);    		
        ttp_table_node_p->max_columns    = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID3_COLUMNS;
        ttp_table_node_p->max_rows = CNTLR_SAMPLE_L2_FWD_TTP_UNICAST_TABLE_ID3_ROWS;
...
SAMPLE_L2_FWD_TTP_INIT_EXIT:
  ttp_tbl_match_field_list_deinit("SAMPLE_L2_FWD_TTP");
  return ret_val;
}


int32_t l2_fwd_ttp_deinit()
{
  ttp_tbl_match_field_list_deinit("SAMPLE_L2_FWD_TTP");
}

int32_t get_first_l2_fwd_ttp_table()
{
}
int32_t get_next_l2_fwd_ttp_table()
{
}
